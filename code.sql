...
INSERT INTO `card_admin` VALUES (1,'admin','九幽','59534e52726ef.jpg','b7a1b6d08af8f9fbc5c009889bb4b165',187,'jian34long@163.com',1,1497332555,'127.0.0.1',1498641871),(4,'JIUYOU','游帝','','d41d8cd98f00b204e9800998ecf8427e',111,'1547560934@qq.com',1,1498531975,'127.0.0.1',1498642022);
...
CREATE TABLE `card_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=133 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='管理员操作日志';

...
INSERT INTO `card_admin` VALUES (1,'admin','九幽','','b7a1b6d08af8f9fbc5c009889bb4b165',0,'jian34long@163.com',1,1497332555,'127.0.0.1',1498405400),(4,'JIUYOU','游帝','','d41d8cd98f00b204e9800998ecf8427e',111,'1547560934@qq.com',3,1498405482,'127.0.0.1',1498399971);
...
INSERT INTO `card_auth_group` VALUES (1,'超级管理员',1,'1,2,4,5,6,7,8,9,24,3,10,11,12,13,14,20,21,22,23,15'),(3,'编辑',1,'1,25');
...
INSERT INTO `card_config` VALUES (1,'cfg_name','网站名称','我的网站','string',1498403757),(2,'cfg_keywords','网站关键字','内容管理系统','string',1498403757),(3,'cfg_description','网站描述','这是基于Auth权限的管理系统','bstring',0),(4,'cfg_powerby','网站底部版权','CopyRight © 2016 九幽IT 版权所有 粤ICP备16060013号-1','string',1498403757),(5,'cfg_log','网站后台操作日志','Y','bool',1497843844),(6,'cfg_url','网站地址','22','string',1498403757),(7,'cfg_verify','登录验证码','N','bool',1497692908);
...
INSERT INTO `card_nav` VALUES (1,0,'系统设置','Admin/ShowNav/config','cog',1),(2,1,'菜单管理','Admin/Nav/index','',1),(3,0,'权限控制','Admin/ShowNav/rule','expeditedssl',2),(4,3,'权限管理','Admin/Rule/index','',1),(5,3,'用户组管理','Admin/Rule/group','',2),(6,3,'管理员列表','Admin/Rule/admin_user_list','',3),(9,1,'系统设置','Admin/Config/index','',2),(13,1,'系统日志','Admin/Config/log','',3);
